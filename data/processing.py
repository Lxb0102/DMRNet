...
def med_process(med_file):
    ...
    if mimiciv:
        med_pd.rename(columns=str.upper,inplace=True)
...
def diag_process(diag_file):
    ...
    if mimiciv:
        diag_pd.rename(columns=str.upper,inplace=True)
...
if __name__ == "__main__":
    ...
    # med_file = "mimiciii/1.4/PRESCRIPTIONS.csv"
    # diag_file = "mimiciii/1.4/DIAGNOSES_ICD.csv"
    # procedure_file = "mimiciii/1.4/PROCEDURES_ICD.csv"
    med_file = "mimiciii/prescriptions.csv"
    diag_file = "mimiciii/d_icd_diagnoses.csv"
    procedure_file = "mimiciii/d_icd_procedures.csv"
